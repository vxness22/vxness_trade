    ...
    try {
      ...
      if (user && user.email) {
        await sendTemplateEmail('challenge_purchased', user.email, {
          ...
          purchaseDate: new Date().toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'medium', timeStyle: 'short' }),
          platformName: 'Vxness',
      ...
      try {
        ...
        if (user && challenge) {
          await sendTemplateEmail('challenge_failed', user.email, {
            ...
            failureDate: account.failedAt.toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'medium' }),
            platformName: 'Vxness',
            loginUrl: 'https://vxness.in/user/login',
            supportEmail: 'support@vxness.in',
            year: new Date().getFullYear().toString()
        ...
        try {
          ...
          if (user) {
            await sendTemplateEmail('challenge_completed', user.email, {
              ...
              fundSize: `$${challenge.fundSize.toLocaleString()}`,
              accountId: account.accountId,
              completionDate: account.passedAt.toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'medium' }),
              platformName: 'Vxness',
              loginUrl: 'https://vxness.in/user/login',
              supportEmail: 'support@vxness.in',
              year: new Date().getFullYear().toString()
