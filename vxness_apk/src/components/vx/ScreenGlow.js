      ...
      <Svg width={SCREEN_W} height={GLOW_H}>
        <Defs>
          <RadialGradient id="screenTopGlow" cx="50%" cy="0%" rx="80%" ry="62%" fx="50%" fy="0%">
            <Stop offset="0" stopColor={vx.accentGlow} stopOpacity={String(o0)} />
            <Stop offset="0.32" stopColor={vx.accent} stopOpacity={String(o1)} />
            <Stop offset="0.62" stopColor={dark ? '#9A2D0B' : vx.accent} stopOpacity={String(o2)} />
            <Stop offset="1" stopColor={vx.bg} stopOpacity="0" />
          </RadialGradient>
        </Defs>
