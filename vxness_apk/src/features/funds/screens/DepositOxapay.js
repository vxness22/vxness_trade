...
const styles = StyleSheet.create({
  ...
  errTxt: { color: vx.textPrimary, fontFamily, fontSize: sizes.body, textAlign: 'center' },
  web: { flex: 1, backgroundColor: '#FFFFFF' },
  footer: { padding: space.lg, gap: space.sm, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: vx.border, backgroundColor: vx.bg },
  footNote: { color: vx.textMuted, fontFamily, fontSize: sizes.label, textAlign: 'center' },
});
