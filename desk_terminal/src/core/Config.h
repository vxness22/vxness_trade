...
public:
    ...
    // UI preferences
    // Where the window was and how big, as QMainWindow::saveGeometry() base64.
    // That blob also carries whether it was MAXIMISED, which is the state this
    // terminal starts in until the trader chooses otherwise.
