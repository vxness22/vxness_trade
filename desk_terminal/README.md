...
- **News** — the TradingView timeline for the instrument in focus, in the
  blotter beside Trade / Pending / History.
- **Economic calendar** — the macro releases behind that instrument (rate
  decisions, CPI, NFP, GDP), filtered by impact and by country.
